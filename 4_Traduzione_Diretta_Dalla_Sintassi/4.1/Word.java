public class Word extends Token {
    public String lexeme = ""; //oltre al campo tag abbiamo una stringa che corrisponde o al token o all'identificatore
    public Word(int tag, String s) { super(tag); lexeme=s; }
    public String toString() { return "<" + tag + ", " + lexeme + ">"; }
    public static final Word //definizione di token costanti
